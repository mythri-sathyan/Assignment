...
2. You can install ownCloud Server in any of the following ways:
  ...
  * **Using Appliance**: It is built on Univention Corporate Server (UCS) that is completely configured with a secure connection and the ownCloud Proxy app.       
  ...
  * **Using Command Line**: This method is recommended for scripted operations and system administrators who prefer using command line instead of GUI. 
